...
<acme:form>
	...
	<acme:form-submit test ="${command == 'show'}" code="administrator.auditorrequest.form.button.create" action="/administrator/auditorrequest/update"/>
	<acme:form-submit test ="${command == 'update'}" code="administrator.auditorrequest.form.button.create" action="/administrator/auditorrequest/update"/>
	</jstl:if>
